...
export BBS_WORK_TOPDIR="/home/biocbuild/bbs-3.0-bioc"
...
export BBS_OUTGOING_MAP="source:zin1/buildsrc win.binary:moscato1/buildbin mac.binary:perceval/buildbin mac.binary.mavericks:oaxaca/buildbin"
...
export BBS_REPORT_NODES="zin1 moscato1:bin perceval:bin oaxaca:bin"
